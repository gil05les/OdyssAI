"""
Logging configuration for MCP Geo Destinations Server.
...
def setup_logger(
    ...
    if log_to_file:
        file_handler = logging.FileHandler(log_file or 'mcp_geo_destinations.log')
