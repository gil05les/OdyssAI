...
Reuses the same client wrapper pattern as mcp-flights and mcp-hotels.
"""
import os
import sys
import time
...
try:
    ...
    # This file is at: OdyssAI/mcp-servers/mcp-cars/amadeus_client.py
    # .env is at: OdyssAI/.env
    # So we go up 3 levels: mcp-cars -> mcp-servers -> OdyssAI
