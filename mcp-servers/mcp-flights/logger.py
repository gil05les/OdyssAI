"""
Logging configuration for MCP Flights Server.
...
def setup_logger(
    name: str = "mcp_flights",
    level: int = logging.DEBUG,
    log_to_file: bool = True,  # Enable file logging by default
    ...
    if log_to_file:
        ...
        if log_file:
            ...
            # Try to use /app/logs (if in Docker) or ./logs (if local)
